...
public class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        builder.ComplexProperty(o => o.ShippingAddres, addressBuilder => 
        {             
            ...
            addressBuilder.Property(a => a.AdressLine).HasMaxLength(180).IsRequired();
        ...
        builder.Property(o => o.Status)
            .HasDefaultValue(OrderStatus.Draft).HasConversion(
